...
export default {
  ...
  methods:{
    ...
    update(value){
        ...
        this.$http.get('/list/getlist.php?pageindex=' + this.$route.params.type + '&online=1' + (!value || value == "-1"?'':'&type='+value),{'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8'}).then(function(response){
  ...
  watch:{
      ...
      $route(to,from){
        if(to.params.id == 3 && from.params.id == 3 || to.params.id == 3 && from.params.type == "new"){
